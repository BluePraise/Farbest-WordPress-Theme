                    ...
                    <div class="ingredient-header-row">
                        ...
                        <div class="ingredient-header-aside">
                            ...
                            if ($first_category) :
                                ...
                                // 2. Fallback to filesystem slug-based file
                            ...
                            ?>
                                    <div class="ingredient-category-icon">
                                        <?php echo $svg_content; // phpcs:ignore WordPress.Security.EscapeOutput
                                        ?>
                                    </div>
                            <?php endif;
                            endif; ?>
