<?php
/**
 * Legacy CPTs — products, homepage, staff, partners.
 * These post types predate the fpc_ingredient plugin and will be
 * phased out after the block theme migration is complete.
 *
 * @package farbest
 */
